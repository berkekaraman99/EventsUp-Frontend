<template>
  <div>
    ...
    <div class="container min-vh-100 d-flex justify-content-center overflow-auto h-100">
      <div class="row w-100 align-items-center my-5 mx-5">
        <div class="col-md-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
          <h1 class="text-center">{{ t('forgotpassword.header') }}</h1>
          <FormKit type="form" :actions="false">
            ...
            >
              ...
              <FormKit type="step" name="Code sending method">
                <h4 class="fw-bold mb-3">
                  {{ t('forgotpassword.codesendstyle') }}
                </h4>
                <FormKit
                  type="radio"
                  label=""
              ...
              <FormKit type="step" name="Enter code">
                <h5 class="formkit-label">
                  {{ t('forgotpassword.enteryourcode') }}
                </h5>
              ...
              <FormKit type="step" name="Enter new password">
                <h2>{{ t('forgotpassword.createnewpassword') }}</h2>
                <FormKit
                  type="password"
                  name="newpassword"
