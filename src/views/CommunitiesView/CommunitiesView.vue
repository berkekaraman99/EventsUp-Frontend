<template>
  <div>
    ...
    <div class="container" v-else>
      <div class="row d-flex justify-content-center align-items-center" v-if="communityList.length">
        <TransitionGroup appear @before-enter="beforeEnterCommunity" @enter="enterCommunity">
          <div
            class="col-12 col-sm-12 col-md-10 offset-md-1"
